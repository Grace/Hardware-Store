...
class HardwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hardware" do
    assert_difference('Hardware.count') do
      post hardwares_url, params: { hardware: { category: @hardware.category, currency: @hardware.currency, description: @hardware.description, name: @hardware.name, price: @hardware.price } }
    end
  ...
  test "should update hardware" do
    patch hardware_url(@hardware), params: { hardware: { category: @hardware.category, currency: @hardware.currency, description: @hardware.description, name: @hardware.name, price: @hardware.price } }
